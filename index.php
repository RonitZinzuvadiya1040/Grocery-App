                ...
                <div class="col-lg-4">
                    <div class="card">
                        <div class="card-body">
                          ...
                          <?php } ?>
    					            <a href="update.php?id=<?php echo $qq['id']; ?>" class="card-link"><button class="btn btn-info">Update</button></a>
                          <a href="delete.php?id=<?php echo $qq['id']; ?>" class="card-link"><button class="btn btn-primary">Delete</button></a>
                        </div>
                      </div><br>
                </div>
                <?php
